        ...
        <div class="pull-left">
          ...
          <div class="header-search">
            <form action="search" method="get">
              <input class="input search-input" type="text" name="searchtext" placeholder="Enter your keyword" style="width:200px; padding-left:10px;">
        ...
        <div class="pull-right">
          <ul class="header-btns">
            ...
            <li class="header-account dropdown default-dropdown">
              ...
              @else
              <a href="{{ url('login')}}" class="text-uppercase">Login</a> / <a href="{{ url('/joinus')}}" class="text-uppercase">Join</a>
              @endif
              <ul class="custom-menu">
        ...
        <div class="menu-nav">
          ...
          <ul class="menu-list">
            ...
            <li class="dropdown default-dropdown"><a class="dropdown-toggle" data-toggle="dropdown" aria-expanded="true">Pages <i class="fa fa-caret-down"></i></a>
             ...
             <li><a href="{{ url('home/createaccount')}}">Create a Store</a></li>
          </ul>
        </div>
        <!-- menu nav -->
      </div>
      ...
      <div class="row">
        ...
        <div class="col-md-3 col-sm-6 col-xs-6">
          <div class="footer">
            ...
            <p style="font-size:12pt;">This was developed by the tech support of efirifie.com</p>
        ...
        <div class="col-md-3 col-sm-6 col-xs-6">
          <div class="footer">
            ...
            <p style="font-size:12pt;">subscribe to get our daily newsletter. Be informed</p>
            <form>
      ...
      <div class="row">
        <div class="col-md-8 col-md-offset-2 text-center">
          ...
          <div class="footer-copyright">
            ...
            Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | efirifie.inc <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="#">ChrisSoft</a>
            <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
          </div>
          <!-- /footer copyright -->
        </div>
