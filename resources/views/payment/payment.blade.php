        ...
        <div class="container">
           ...
           <div class="payments-methods">
							<div class="section-title">
								<h4 class="title">Payments Details</h4>
							</div>
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                   <div class="form-group">
                                        <label for="Network" name="network">Select your network</label>
                                      ...
                                      <div class="form-group">
                                            <label for="Network-Number">Mobile Number</label>
                                            <input type="text" class="form-control" id="number" name="mobilenumber" placeholder="Registered mobile number" required>
                                        </div>
                                  </div> <br>
                                  <div class="pull-right">
                                    <button type="submit" class="primary-btn" name="pay">Pay</button>
								<!-- <a href="{{route('makepayment')}}" class="primary-btn">Pay</a> -->
							</div>
